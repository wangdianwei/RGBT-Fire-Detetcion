...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='D:\yk\YOLOv11-RGBT-master_final\\runs\YOLOV11-midfusion-3m\weights\\best.pt', help='trained weights path')
    ...
    parser.add_argument('--channels', default=4, type=int, help='channels')
